...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Kaan Ozcelik"
        self.author_email = "kaan@openmailbox.org"
        self.copyright = "Copyright (c) 2016."
 
        #Description
        self.project_description = "A Simple Arrow Key Demonstration."
        ...
        #Dist directory
        self.dist_dir ='Compiled Version'
